...
class MDSliderController extends ControllerBase {
  ...
  public function listMDSlider() {
    ...
    return array(
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => t('No MegaSlider available. <a href="@link">Add MegaSlider</a>.', array('@link' => \Drupal\Core\Url::fromRoute('md_slider.admin.add'))),
  ...
  public function editMDSlider($slider) {
    ...
    $json_url = Url::fromRoute('md_slider.admin.json_response', array(), array('absolute' => TRUE));
    $html_url = Url::fromRoute('md_slider.admin.html_response', array(), array('absolute' => TRUE));
    $image_url = Url::fromRoute('md_slider.admin.image', array(), array('absolute' => TRUE));
