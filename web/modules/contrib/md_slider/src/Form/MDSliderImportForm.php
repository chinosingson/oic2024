...
class MDSliderImportForm extends FormBase {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $writable = \Drupal::service('file_system')->prepareDirectory($destination_dir, \Drupal\Core\File\FileSystemInterface::CREATE_DIRECTORY);
    if (!$writable) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::messenger()->addMessage($this->t("MD Slider: Import successful!"));
  }
}
