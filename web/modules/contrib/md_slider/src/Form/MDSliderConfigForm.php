  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($is_new) {
      ...
      if ($response) {
        ...
        \Drupal\Core\File\FileSystemInterface::saveData($css_content, $destination_dir . "/md-slider-{$slider->machine_name}-layers.css", \Drupal\Core\File\FileSystemInterface::EXISTS_REPLACE);
        \Drupal::messenger()->addMessage($this->t('Slider %slider has been created.', array('%slider' => $slider->title)));
