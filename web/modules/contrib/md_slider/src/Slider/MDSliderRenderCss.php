...
class MDSliderRenderCss{
  ...
  public static function saveFileCss($slider_name, $style) {
    ...
    \Drupal\Core\File\FileSystemInterface::saveData($css, $destination_dir . "/md-slider-{$slider_name}-layers.css", \Drupal\Core\File\FileSystemInterface::EXISTS_REPLACE);
  }
}
