...
namespace Drupal\n1ed\Flmngr\lib\file\blurHash;

use InvalidArgumentException;

class Blurhash {

  public static function encode($image, $components_x = 4, $components_y = 4, $linear = FALSE) {
  ...
  public static function decode($blurhash, $width, $height, $punch = 1.0, $linear = FALSE) {
